	...
	public function render(): string {
		...
		<div class="traveljabs-clinic-submission__form-wrap">
			...
			<form method="post" enctype="multipart/form-data" class="traveljabs-clinic-submission__form">
				...
				<p class="traveljabs-featured-image-field"><label for="traveljabs-clinic-featured-image-upload"><?php echo esc_html__( 'Featured Image', 'traveljabs' ); ?></label><img class="traveljabs-featured-image-preview<?php echo $image_url ? '' : ' is-empty'; ?>" src="<?php echo esc_url( $image_url ?: '' ); ?>" alt="<?php echo esc_attr__( 'Featured image preview', 'traveljabs' ); ?>"><input type="file" name="clinic_featured_image_upload" id="traveljabs-clinic-featured-image-upload" class="traveljabs-clinic-featured-image-upload" accept="image/jpeg,image/png,image/gif,image/webp"></p>
